...
import com.takeaway.employeeservice.integationsupport.entity.AbstractEntity;
...
/**
 * User: StMinko Date: 18.03.2019 Time: 11:30
 *
 * <p>
 */
@Audited
...
@SequenceGenerator(name = "department_sequence",allocationSize = 1,sequenceName = "department_sequence",schema = "data")
