...
class EmployeeRestTest extends RestTestSuite
{
  ...
  class WhenCreate
  {
    ...
    void givenOnlyDepartment_whenCreateEmployee_thenStatus201()
    {
      String departmentName = RandomStringUtils.randomAlphabetic(23);
      createAndPersistDepartment(departmentName);
      CreateEmployeeRequest employeeRequest = createEmployeeRequestTestFactory
              .builder()
              .birthday(null)
              .emailAddress(null)
              .firstName(null)
    ...
    void givenAlreadyUsedEmail_whenCreateEmployee_thenStatus400()
    {
      ...
      CreateEmployeeRequest newEmployeeRequest = createEmployeeRequestTestFactory.builder().emailAddress(employeeRequest.getEmailAddress()).create();
    ...
    {
      // Arrange
      CreateEmployeeRequest createEmployeeRequest = createEmployeeRequestTestFactory
              .builder()
              .birthday(null)
              .emailAddress(null)
              .firstName(null)
  ...
  class WhenPartialUpdate
  {
    ...
    void givenUnknownEmployee_whenUpdateEmployee_thenStatus404()
    {
      ...
      String departmentName = RandomStringUtils.randomAlphabetic(23);
      createAndPersistDepartment(departmentName);
      UpdateEmployeeRequest updateEmployeeRequest = updateEmployeeRequestTestFactory.builder().departmentName(departmentName).create();
      HttpHeaders headers = defaultHttpHeaders();
      UUID wrongUuid = UUID.randomUUID();
    ...
    void givenValidParameters_whenUpdateEmployee_thenStatus204()
    {
      ...
      UpdateEmployeeRequest updateRequest = updateEmployeeRequestTestFactory.builder().departmentName(secondDepartmentName).create();
      HttpHeaders headers = defaultHttpHeaders();
