        ...
        implements EntityService<ENTITY, ID>
{
    ...
    /**
     * Extension Point for before create actions. Modify ENTITY typed Entity to create. Default implementation returns
     * parameter create unmodified.
     *
    ...
    /**
     * Extension Point for after create actions. Modify ENTITY typed Entity that was created. Default implementation
     * returns parameter created unmodified.
     *
    ...
    /**
     * Extension Point for before update actions. Modify ENTITY typed Entity to update. Default implementation returns
     * parameter update unmodified.
     *
    ...
    /**
     * Extension Point for after update actions. Modify ENTITY typed Entity that was updated. Default implementation
     * returns parameter updated unmodified.
     *
     * @param updated The ENTITY typed Entity that was updated
     * @return The after update actions modified Entity to update. Default implementation returns the input parameter
     * update.
     */
    ...
    /**
     * Extension Point for before delete actions. Modify id to delete Entity for. Default implementation returns
     * parameter id unmodified.
     *
     * @param id The ID typed Entity id
     * @return The before delete actions modified id to delete Entity for. Default implementation returns the input
     * parameter id.
     */
    ...
    /**
     * Extension Point for after delete actions. Perform after delete actions on the deleted Entity and its id. Default
     * Implemetnation does nothing
     *
     * @param id      The ID typed Entity id
