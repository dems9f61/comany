...
import com.takeaway.authorization.integrationsupport.control.EntityService;
import com.takeaway.authorization.integrationsupport.entity.AbstractEntity;
import com.takeaway.authorization.integrationsupport.entity.ResourceNotFoundException;
    ...
    implements DefaultEntityController<ENTITY, ID>, ServiceExceptionTranslator
{
  ...
  /**
   * Extension Point for after create actions. Should return the ENTITY to create. Default implementation returns the input parameter create. Only called if an Entity could be
   * created.
   *
  ...
  /**
   * Extension Point for before delete actions. Modify id if necessary. Default implementation returns the input parameter id. Only called if an Entity could be found for id.
   *
