...
class OauthClientControllerIntegrationTest extends IntegrationTestSuite
{
    ...
    class WhenAccess
    {
        ...
        void givenOAuthClient_whenFindById_thenStatus200AndReturnOAuthClient() throws Exception
        {
            ...
            assertThat(oAuthClient.getClientSecret()).isEqualTo(persistedOauthClient.getClientSecret());
    ...
    class WhenCreate
    {
        ...
        void givenValidCreateRequest_whenCreate_thenStatus201AndReturnNewOAuthClient() throws Exception
        {
            ...
            assertThat(created.getClientSecret()).isEqualTo(toPersist.getClientSecret());
    ...
    class WhenUpdate
    {
        ...
        void givenValidFullRequest_whenDoFullUpdate_thenStatus200AndReturnUpdated() throws Exception
        {
            ...
            assertThat(updated.getClientSecret()).isEqualTo(update.getClientSecret());
    ...
    private List<OauthClient> saveRandomOAuthClients(int count) throws Exception
    {
